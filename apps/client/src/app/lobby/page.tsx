...
export default function LobbyPage({ username, roomId }: any) {
  ...
  return (
    <div className='mt-2 flex w-screen flex-col items-center px-3 py-2'>
      <div className='mt-2 flex flex-col items-center gap-2 px-3 py-2 text-2xl'>
        ...
        <div className='flex w-screen items-center gap-4 px-6'>
